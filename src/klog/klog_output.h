...
void klog_output_console(const uint32_t* thread_id, const KlogString* p_time, const KlogString* p_name, const KlogString* p_level, const KlogString* p_source_location, const KlogString* p_message);
